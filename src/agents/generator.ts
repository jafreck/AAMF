 ...
 *
 * Templates live in `agents/templates/<agent-name>.md` and contain the
 ...
 * Partials live in `agents/templates/_partials/<name>.md` and support
...
/** Default template directory: `agents/templates/` */
